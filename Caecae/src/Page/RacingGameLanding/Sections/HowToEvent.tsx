                                ...
                                <div className="flex flex-row justify-center items-center gap-10 mt-14">
                                    <div className="flex flex-col">
                                        <div className="relative inline-block">
                                            ...
                                            <img src="/src/Shared/assets/trapezoid1.svg" alt="trapezoid1" />
                                        </div>
                                    ...
                                    <div className="flex flex-row justify-center items-center gap-10 mt-14">
                                        <div className="flex flex-col">
                                            <div className="relative inline-block">
                                                ...
                                                <img src="/src/Shared/assets/trapezoid2.svg" alt="trapezoid2" />
                                            </div>
                                            <div>
                                                <div className="flex flex-col p-2 border-white border-2">
                                        ...
                                        <div className="flex flex-col">
                                            <div className="relative inline-block">
                                                <span className="absolute inset-1 pl-1 text-black font-galmuri font-bold text-[16px]">
                                                    Case 3. 여행의 정석
                                                    <span className="text-black text-[12px] pl-2">Camping</span>
                                                </span>
                                                <img src="/src/Shared/assets/trapezoid2.svg" alt="trapezoid2" />
                                            </div>
                                            <div>
                                    ...
                                    <div className="flex flex-row justify-center items-center gap-10 mt-10">
                                        <div className="flex flex-col">
                                            <div className="relative inline-block">
                                                <span className="absolute inset-1 pl-1 text-black font-galmuri font-bold text-[16px]">
                                                    Case 4. 여행의 정석
                                                    <span className="text-black text-[12px] pl-2">Picnic</span>
                                                </span>
                                                <img src="/src/Shared/assets/trapezoid2.svg" alt="trapezoid2" />
                                            </div>
                                            <div>
